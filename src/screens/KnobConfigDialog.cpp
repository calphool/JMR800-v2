...
#include "widgets/PushButtonWidget.h"
    ...
    void KnobConfigDialog::onEnter() {
        ...
        Widget* eanw = new EncoderAttachedNumericWidget(xoffset + 90, yoffset + 20, 0, 255, buf);
        widgets.push_back(eanw);
        Widget* textLabel3 = new TextLabelWidget("Type Code:", xoffset + 2, yoffset + 30, 1, false, LabelColor::WHITE);
